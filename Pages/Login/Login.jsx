  ...
  async function signInWithGoogleAsync() {
    try {
      const result = await Google.logInAsync({
        androidClientId: '105929197820-9tdidelo848nqp7a0jcjftpl4vt7uem7.apps.googleusercontent.com',
        iosClientId: '105929197820-nsonlqf9avh27cioojerpad08krl33ub.apps.googleusercontent.com',
          ...
          <View style={styles.loginContainer}>
            ...
            <View style={styles.btnLogin}>
              ...
              >
                ...
                <Text style={[styles.textSign, {fontStyle:'italic'}]}>Facebook</Text>
                <MaterialIcons name="navigate-next" color="#fff" size={20} />
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={[styles.textSign, {fontStyle:'italic' , color: 'black'}]}>Google</Text>
